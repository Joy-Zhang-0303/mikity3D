...
public class OpenglesCone extends AbstractOpenglesObject {
  ...
  /** 側面のポリゴン。 */
  private OpenglesTrianglePolygon[] sidePolygons;
  /**
   * {@inheritDoc}
   */
  ...
  private void updatePolygons() {
    ...
    this.sidePolygons = new OpenglesTrianglePolygon[this.division];
    for (int i = 0; i < this.division; i++) {
      this.sidePolygons[i] = new OpenglesTrianglePolygon();
      final float[][] vertices = new float[3][3];
