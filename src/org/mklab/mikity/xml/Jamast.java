...
//  private org.mklab.mikity.xml.blender.Scene scene;
    ...
    public Jamast() {
        super();
        _modelList = new java.util.ArrayList<Model>();
        _configList = new java.util.ArrayList<Config>();
     ...
     */
    public void addConfig(org.mklab.mikity.xml.Config vConfig)
        throws java.lang.IndexOutOfBoundsException
    {
        _configList.add(vConfig);
     ...
     * @throws java.lang.IndexOutOfBoundsException 
     */
    public void addConfig(int index, org.mklab.mikity.xml.Config vConfig)
        throws java.lang.IndexOutOfBoundsException
    {
        _configList.add(index, vConfig);
     ...
     * @throws java.lang.IndexOutOfBoundsException 
     */
    public void addModel(org.mklab.mikity.xml.Model vModel)
        throws java.lang.IndexOutOfBoundsException
    {
     ...
     * @throws java.lang.IndexOutOfBoundsException 
     */
    public void addModel(int index, org.mklab.mikity.xml.Model vModel)
        throws java.lang.IndexOutOfBoundsException
    {
    ...
    {
        return new org.exolab.castor.util.IteratorEnumeration(_configList.iterator());
    ...
    public boolean equals(java.lang.Object obj)
    {
        ...
        if (obj instanceof Jamast) {
            ...
            if (this._modelList != null) {
                ...
                else if (!(this._modelList.equals(temp._modelList))) 
                    return false;
            }
            else if (temp._modelList != null)
                return false;
            if (this._configList != null) {
                if (temp._configList == null) return false;
                else if (!(this._configList.equals(temp._configList))) 
                    return false;
            }
            else if (temp._configList != null)
                return false;
            return true;
        }
        return false;
     ...
     * @throws java.lang.IndexOutOfBoundsException 
     */
    public org.mklab.mikity.xml.Config loadConfig(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        ...
        return (org.mklab.mikity.xml.Config) _configList.get(index);
    ...
    {
        int size = _configList.size();
        org.mklab.mikity.xml.Config[] mArray = new org.mklab.mikity.xml.Config[size];
        for (int index = 0; index < size; index++) {
            mArray[index] = (org.mklab.mikity.xml.Config) _configList.get(index);
        }
        return mArray;
    } //-- org.mklab.mikity.xml.Config[] getConfig() 

    /**
     * Method getConfigAsReferenceReturns a reference to 'config'.
     ...
     * @throws java.lang.IndexOutOfBoundsException 
     */
    public org.mklab.mikity.xml.Model loadModel(int index)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
    ...
    public org.mklab.mikity.xml.Model[] loadModel()
    {
        ...
        for (int index = 0; index < size; index++) {
            mArray[index] = (org.mklab.mikity.xml.Model) _modelList.get(index);
        }
        return mArray;
    } //-- org.mklab.mikity.xml.Model[] getModel() 

    /**
     * Method getModelAsReferenceReturns a reference to 'model'. No
    ...
    {
        boolean removed = _configList.remove(vConfig);
        return removed;
     ...
     * @throws java.lang.IndexOutOfBoundsException 
     */
    public void setConfig(int index, org.mklab.mikity.xml.Config vConfig)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _configList.size())) {
    ...
    public void setConfig(org.mklab.mikity.xml.Config[] configArray)
    {
        ...
        for (int i = 0; i < configArray.length; i++) {
            _configList.add(configArray[i]);
        }
    } //-- void setConfig(org.mklab.mikity.xml.Config) 

    /**
     * Method setConfigSets the value of 'config' by copying the
     * given ArrayList.
     * 
...
//    } //-- void setConfig(java.util.ArrayList) 
    ...
    /**
     * Method setConfigAsReferenceSets the value of 'config' by
     ...
     * @throws java.lang.IndexOutOfBoundsException 
     */
    public void setModel(int index, org.mklab.mikity.xml.Model vModel)
        throws java.lang.IndexOutOfBoundsException
    {
        //-- check bounds for index
        if ((index < 0) || (index > _modelList.size())) {
    ...
    /**
     * Method setModelSets the value of 'model' by copying the
     * given ArrayList.
     * 
...
//    } //-- void setModel(java.util.ArrayList) 
    ...
    /**
     * Method setModelAsReferenceSets the value of 'model' by
     * setting it to the given ArrayList. No type checking is
     * performed.
     * 
