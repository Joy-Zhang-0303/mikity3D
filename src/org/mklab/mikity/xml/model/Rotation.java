...
public class Rotation implements java.io.Serializable {
	...
	public boolean equals(java.lang.Object obj)
	{
		...
		if (obj instanceof Rotation) {
			...
			if (this._xrotate != temp._xrotate)
				return false;
			if (this._has_xrotate != temp._has_xrotate)
				return false;
			if (this._yrotate != temp._yrotate)
				return false;
			if (this._has_yrotate != temp._has_yrotate)
				return false;
			if (this._zrotate != temp._zrotate)
				return false;
			if (this._has_zrotate != temp._has_zrotate)
				return false;
			return true;
		}
		return false;
