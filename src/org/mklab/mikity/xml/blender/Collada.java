...
public class Collada {
	 ...
	 */
	public Collada(){
		library_visual_scenes = new Library_visual_scenes();
	...
	public Group getBlenderPolygonGroup(){
		library_visual_scenes.createMatrix();
		library_geometries.setLibraryVisualScenes(library_visual_scenes);
		return library_geometries.getBlenderPolygonGroup();
	}
}
