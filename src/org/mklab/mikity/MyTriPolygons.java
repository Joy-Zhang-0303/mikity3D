...
public class MyTriPolygons extends MyTransformGroup
{
     ...
     * @param mode
     */
    public MyTriPolygons(Point3d[] vertex,Material material,
                              TransparencyAttributes transAttr,int mode) 
    {
        //形状の枠組み生成
    ...
    private Geometry geometry(Point3d[] vertex)
    {
        ...
        normalGen.setCreaseAngle(creaseAngle);
        normalGen.generateNormals(info);
 
        //形状の取得
        geom=info.getGeometryArray();
     ...
     * @return app
     */
    private Appearance appearance(Material material,
                              TransparencyAttributes transAttr,int mode)
    {
        //色の設定
        app=new Appearance();
