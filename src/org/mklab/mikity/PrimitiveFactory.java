...
//		//MyTransformGroup と Groupの関連付けを行う
	...
	public static MyTransformGroup create(XMLTrianglePolygon triangle) {
		...
		= new IndexedTriangleArray(vertices.length, IndexedTriangleArray.COORDINATES | IndexedTriangleArray.COLOR_3 | IndexedTriangleArray.NORMALS, indices.length);
...
//		法線配列追加
	...
	public static MyTransformGroup create(XMLQuadPolygon quad) {
		...
		= new IndexedQuadArray(vertices.length, IndexedQuadArray.COORDINATES | IndexedQuadArray.COLOR_3 | IndexedQuadArray.NORMALS, indices.length);
		geometry.setCoordinates(0, vertices);
		//法線配列追加
		geometry.setNormals(0, normals);
		geometry.setCoordinateIndices(0, indices);
	...
	private static MyTransformGroup setMatrix(Matrix4f matrix, MyTransformGroup tg) {
		if(matrix != null){
			...
			mat3.setM00(matrix.getM00());mat3.setM01(matrix.getM01());mat3.setM02(matrix.getM02());
			mat3.setM10(matrix.getM10());mat3.setM11(matrix.getM11());mat3.setM12(matrix.getM12());
			mat3.setM20(matrix.getM20());mat3.setM21(matrix.getM21());mat3.setM22(matrix.getM22());
			tg.mulRotation(mat3);
