...
public class DragAndDropEnabler {
  ...
  private class MyDropTargetListener implements DropTargetListener{
    ...
    public void drop(DropTargetEvent e) {
      ...
      Object obj = dragItem.getData();
      Group sourceGroup = (Group)dragItem.getParentItem().getData();
...
//  }
  ...
  private class MyDragSourceListener implements DragSourceListener{
    ...
    public void dragStart(DragSourceEvent e) {
      //選択要素が1つでないときは、終了
      if(tree.getSelectionCount()!=1 || tree.getSelection()[0].getParentItem() == null){
        e.doit = false;
        return;
      }
      dragItem = tree.getSelection()[0];
    }
