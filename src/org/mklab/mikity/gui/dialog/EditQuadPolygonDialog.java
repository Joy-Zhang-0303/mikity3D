...
public class EditQuadPolygonDialog {
	...
	private void createSShell() {
		...
		layout.numColumns = 2;
		sShell.setSize(new org.eclipse.swt.graphics.Point(400, 720));
		sShell.setText("四角形ポリゴンの編集");
		...
		paramX_4 = new ParameterInputBox(beforeGroup, SWT.READ_ONLY, "頂点4 X座標", "0.0");
		paramY_4 = new ParameterInputBox(beforeGroup, SWT.READ_ONLY, "頂点4 Y座標", "0.0");
		paramZ_4 = new ParameterInputBox(beforeGroup, SWT.READ_ONLY, "頂点4 Z座標", "0.0");
		...
		Label label7 = new Label(afterGroup, SWT.SEPARATOR | SWT.HORIZONTAL);
		setGridLayout(label7,3);

		newParamX_4 = new ParameterInputBox(afterGroup, SWT.NONE, "→", "0.0");
		new UnitLabel(afterGroup, "modelLength");
		newParamY_4 = new ParameterInputBox(afterGroup, SWT.NONE, "→", "0.0");
		new UnitLabel(afterGroup, "modelLength");
		newParamZ_4 = new ParameterInputBox(afterGroup, SWT.NONE, "→", "0.0");
		new UnitLabel(afterGroup, "modelLength");

		Label colorLabel4 = new Label(afterGroup, SWT.RIGHT);
		colorLabel4.setText("→");
		setGridLayout(colorLabel4,1);
		colorCombo = new ColorComboBox(afterGroup, COLORS);
		colorCombo.createColorCombo();
		Label label8 = new Label(afterGroup, SWT.SEPARATOR | SWT.HORIZONTAL);
