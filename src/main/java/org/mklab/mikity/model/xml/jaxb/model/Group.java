...
public class Group implements java.io.Serializable {
   ...
   * @return mArray
   */
  public org.mklab.mikity.model.xml.jaxb.model.Group[] getGroups() {
    final int size = this._groupList.size();
    final org.mklab.mikity.model.xml.jaxb.model.Group[] groups = new org.mklab.mikity.model.xml.jaxb.model.Group[size];
   ...
   * @return mArray
   */
  public org.mklab.mikity.model.xml.jaxb.model.LinkData[] getLinkData() {
    final int size = this._linkdataList.size();
    final org.mklab.mikity.model.xml.jaxb.model.LinkData[] linkDatas = new org.mklab.mikity.model.xml.jaxb.model.LinkData[size];
    for (int i = 0; i < size; i++) {
   ...
   */
  public org.mklab.mikity.model.xml.jaxb.model.Location getLocation() {
   ...
   */
  public org.mklab.mikity.model.xml.jaxb.model.Rotation getRotation() {
   ...
   * @return mArray
   */
  public org.mklab.mikity.model.xml.jaxb.model.XMLBox[] getXMLBox() {
    final int size = this._XMLBoxList.size();
    final org.mklab.mikity.model.xml.jaxb.model.XMLBox[] boxes = new org.mklab.mikity.model.xml.jaxb.model.XMLBox[size];
    for (int i = 0; i < size; i++) {
   ...
   * @return mArray
   */
  public org.mklab.mikity.model.xml.jaxb.model.XMLCone[] getXMLCone() {
    final int size = this._XMLConeList.size();
    final org.mklab.mikity.model.xml.jaxb.model.XMLCone[] cones = new org.mklab.mikity.model.xml.jaxb.model.XMLCone[size];
    for (int i = 0; i < size; i++) {
   ...
   * @return _XMLCylinderList.get(index)
   */
  public org.mklab.mikity.model.xml.jaxb.model.XMLCylinder[] getXMLCylinder() {
    final int size = this._XMLCylinderList.size();
    final org.mklab.mikity.model.xml.jaxb.model.XMLCylinder[] cylinders = new org.mklab.mikity.model.xml.jaxb.model.XMLCylinder[size];
    for (int i = 0; i < size; i++) {
   ...
   * @return mArray
   */
  public org.mklab.mikity.model.xml.jaxb.model.XMLSphere[] getXMLSphere() {
    final int size = this._XMLSphereList.size();
    final org.mklab.mikity.model.xml.jaxb.model.XMLSphere[] spheres = new org.mklab.mikity.model.xml.jaxb.model.XMLSphere[size];
    for (int i = 0; i < size; i++) {
   ...
   * @return mArray
   */
  public org.mklab.mikity.model.xml.jaxb.model.XMLTrianglePolygon[] getXMLTrianglePolygon() {
    final int size = this._XMLTrianglePolygonList.size();
    final org.mklab.mikity.model.xml.jaxb.model.XMLTrianglePolygon[] trianglePolygons = new org.mklab.mikity.model.xml.jaxb.model.XMLTrianglePolygon[size];
    for (int i = 0; i < size; i++) {
   ...
   * @return mArray
   */
  public org.mklab.mikity.model.xml.jaxb.model.XMLQuadPolygon[] getXMLQuadPolygon() {
    final int size = this._XMLQuadPolygonList.size();
    final org.mklab.mikity.model.xml.jaxb.model.XMLQuadPolygon[] quadPolygons = new org.mklab.mikity.model.xml.jaxb.model.XMLQuadPolygon[size];
    for (int i = 0; i < size; i++) {
   ...
   * @return removed
   */
  public boolean removeGroup(org.mklab.mikity.model.xml.jaxb.model.Group vGroup) {
   ...
   * @return removed
   */
  public boolean removeLinkdata(org.mklab.mikity.model.xml.jaxb.model.LinkData vLinkdata) {
   ...
   * @return removed
   */
  public boolean removeXMLBox(org.mklab.mikity.model.xml.jaxb.model.XMLBox vXMLBox) {
   ...
   * @return removed
   */
  public boolean removeXMLCone(org.mklab.mikity.model.xml.jaxb.model.XMLCone vXMLCone) {
   ...
   * @return removed
   */
  public boolean removeXMLCylinder(org.mklab.mikity.model.xml.jaxb.model.XMLCylinder vXMLCylinder) {
   ...
   * @return removed
   */
  public boolean removeXMLSphere(org.mklab.mikity.model.xml.jaxb.model.XMLSphere vXMLSphere) {
   ...
   * @return removed
   */
  public boolean removeXMLTrianglePolygon(org.mklab.mikity.model.xml.jaxb.model.XMLTrianglePolygon vXMLTrianglePolygon) {
   ...
   * @return removed
   */
  public boolean removeXMLQuadPolygon(org.mklab.mikity.model.xml.jaxb.model.XMLQuadPolygon vXMLQuadPolygon) {
   ...
   */
  public void setGroup(org.mklab.mikity.model.xml.jaxb.model.Group[] groupArray) {
    // -- copy array
    this._groupList.clear();
   ...
   */
  public void setLinkData(org.mklab.mikity.model.xml.jaxb.model.LinkData[] linkdataArray) {
    // -- copy array
    this._linkdataList.clear();
   ...
   */
  public void setLocation(org.mklab.mikity.model.xml.jaxb.model.Location location) {
   ...
   */
  public void setRotation(org.mklab.mikity.model.xml.jaxb.model.Rotation rotation) {
   ...
   */
  public void setXMLBox(org.mklab.mikity.model.xml.jaxb.model.XMLBox[] XMLBoxArray) {
    // -- copy array
    this._XMLBoxList.clear();
   ...
   */
  public void setXMLCone(org.mklab.mikity.model.xml.jaxb.model.XMLCone[] XMLConeArray) {
    // -- copy array
    this._XMLConeList.clear();
   ...
   */
  public void setXMLCylinder(org.mklab.mikity.model.xml.jaxb.model.XMLCylinder[] XMLCylinderArray) {
    // -- copy array
    this._XMLCylinderList.clear();
   ...
   */
  public void setXMLSphere(org.mklab.mikity.model.xml.jaxb.model.XMLSphere[] XMLSphereArray) {
    // -- copy array
    this._XMLSphereList.clear();
   ...
   */
  public void setXMLTrianglePolygon(org.mklab.mikity.model.xml.jaxb.model.XMLTrianglePolygon[] XMLTrianglePolygonArray) {
    // -- copy array
    this._XMLTrianglePolygonList.clear();
   ...
   */
  public void setXMLQuadPolygon(org.mklab.mikity.model.xml.jaxb.model.XMLQuadPolygon[] XMLQuadPolygonArray) {
    // -- copy array
    this._XMLQuadPolygonList.clear();
