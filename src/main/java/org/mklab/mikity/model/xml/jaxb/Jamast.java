...
public class Jamast implements java.io.Serializable {
   ...
   * @return removed
   */
  public boolean removeConfig(org.mklab.mikity.model.xml.jaxb.JamastConfig vConfig) {
   ...
   * @return removed
   */
  public boolean removeModel(org.mklab.mikity.model.xml.jaxb.JamastModel vModel) {
