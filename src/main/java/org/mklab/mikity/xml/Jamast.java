...
public class Jamast implements java.io.Serializable {
   ...
   */
  public void addConfig(org.mklab.mikity.xml.JamastConfig vConfig) throws java.lang.IndexOutOfBoundsException {
   ...
   * @throws java.lang.IndexOutOfBoundsException 例外
   */
  public void addConfig(int index, org.mklab.mikity.xml.JamastConfig vConfig) throws java.lang.IndexOutOfBoundsException {
   ...
   * @throws java.lang.IndexOutOfBoundsException 例外
   */
  public void addModel(org.mklab.mikity.xml.JamastModel vModel) throws java.lang.IndexOutOfBoundsException {
   ...
   * @throws java.lang.IndexOutOfBoundsException 例外
   */
  public void addModel(int index, org.mklab.mikity.xml.JamastModel vModel) throws java.lang.IndexOutOfBoundsException {
...
//  }
   ...
   * @throws java.lang.IndexOutOfBoundsException 例外
   */
  public org.mklab.mikity.xml.JamastConfig loadConfig(int index) throws java.lang.IndexOutOfBoundsException {
   ...
   * @return mArray
   */
  public org.mklab.mikity.xml.JamastConfig[] loadConfig() {
    int size = this._configList.size();
    org.mklab.mikity.xml.JamastConfig[] mArray = new org.mklab.mikity.xml.JamastConfig[size];
   ...
   * @throws java.lang.IndexOutOfBoundsException 例外
   */
  public org.mklab.mikity.xml.JamastModel loadModel(int index) throws java.lang.IndexOutOfBoundsException {
    // -- check bounds for index
   ...
   * @return mArray
   */
  public org.mklab.mikity.xml.JamastModel[] loadModel() {
    int size = this._modelList.size();
    org.mklab.mikity.xml.JamastModel[] mArray = new org.mklab.mikity.xml.JamastModel[size];
    for (int index = 0; index < size; index++) {
   ...
   * @return removed
   */
  public boolean removeConfig(org.mklab.mikity.xml.JamastConfig vConfig) {
   ...
   * @return removed
   */
  public boolean removeModel(org.mklab.mikity.xml.JamastModel vModel) {
   ...
   * @throws java.lang.IndexOutOfBoundsException 例外
   */
  public void setConfig(int index, org.mklab.mikity.xml.JamastConfig vConfig) throws java.lang.IndexOutOfBoundsException {
    // -- check bounds for index
    if ((index < 0) || (index > this._configList.size())) {
      throw new IndexOutOfBoundsException();
    }
   ...
   */
  public void setConfig(org.mklab.mikity.xml.JamastConfig[] configArray) {
    // -- copy array
    this._configList.clear();
   ...
   * @throws java.lang.IndexOutOfBoundsException 例外
   */
  public void setModel(int index, org.mklab.mikity.xml.JamastModel vModel) throws java.lang.IndexOutOfBoundsException {
    // -- check bounds for index
    if ((index < 0) || (index > this._modelList.size())) {
      throw new IndexOutOfBoundsException();
    }
   ...
   */
  public void setModel(org.mklab.mikity.xml.JamastModel[] modelArray) {
    // -- copy array
    this._modelList.clear();
