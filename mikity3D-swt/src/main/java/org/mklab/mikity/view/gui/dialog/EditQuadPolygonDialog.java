 ...
 */
public class EditQuadPolygonDialog extends AbstractEditPrimitiveDialog {
   ...
   * @param modeler モデラー
   */
  public EditQuadPolygonDialog(Shell parentShell, PrimitiveModel primitive, GroupModel group, SceneGraphTree tree, JoglModeler modeler) {
