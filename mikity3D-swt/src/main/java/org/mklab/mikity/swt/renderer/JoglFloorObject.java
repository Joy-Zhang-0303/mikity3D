...
public class JoglFloorObject {
   ...
   */
  public JoglFloorObject(ConfigurationModel configuration) {
   ...
   * @param gl GL　
   */
  private void applyColorBright(GL2 gl) {
    ...
    gl.glMaterialf(GL.GL_FRONT_AND_BACK, GLLightingFunc.GL_SHININESS, 120.0f);
   ...
   * @param gl GL　
   */
  private void applyColorDark(GL2 gl) {
    final float specular[] = {0.1f, 0.1f, 0.1f, 1.0f}; // 鏡面光
    final float ambient[] = {0.6f, 0.6f, 0.6f, 1.0f}; // 環境光
   ...
   * @param gl GL
   */
  private void drawObjectBright(GL2 gl) {
   ...
   * @param gl GL
   */
  private void drawObjectDark(GL2 gl) {
